...
class Review(TypedDict):
    ...
    sentiment: Annotated[Literal["pos","neg"],"Return sentiment of review wither positive, negative or neutral"]
    pros: Annotated[Optional[list[str]],"Write down all the pros in a list"]
    cons: Annotated[Optional[list[str]],"Write down all the pros in a list"]
